...
This example presents usage of MultiAssertAttribute.")]
    public partial class Calculator_feature
    {
        ...
        [Scenario]
        [MultiAssert]
        [Sync(nameof(Calculator_feature), nameof(Adding_numbers))]
        ...
        [Scenario]
        [MultiAssert]
        [Sync(nameof(Calculator_feature), nameof(Dividing_numbers))]
        ...
        [Scenario]
        [MultiAssert]
        [Sync(nameof(Calculator_feature), nameof(Multiplying_numbers))]
        ...
        [Scenario]
        [MultiAssert]
        [Sync(nameof(Calculator_feature), nameof(Composite_operations))]
