...
I want to add and browse my client postal addresses by client emails")]
    ...
    {
        [Scenario]
        [Sync(nameof(Address_book_feature), nameof(Adding_contacts))]
        ...
        [Scenario]
        [Sync(nameof(Address_book_feature), nameof(Matching_addresses_by_email))]
        ...
        [Scenario]
        [Sync(nameof(Address_book_feature), nameof(Persisting_address_book))]
        ...
        [Scenario]
        [Sync(nameof(Address_book_feature), nameof(Retrieving_postal_addresses))]
