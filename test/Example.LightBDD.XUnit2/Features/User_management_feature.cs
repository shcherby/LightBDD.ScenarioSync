...
I want to be able to retrieve user data")]
    ...
    {
        [Scenario]
        [Sync(nameof(User_management_feature), nameof(Retrieving_user_details))]
        ...
        [Scenario]
        [Sync(nameof(User_management_feature), nameof(Validating_user_details))]
        ...
        [Scenario]
        [Sync(nameof(User_management_feature), nameof(User_search))]
        ...
        [Scenario]
        [Sync(nameof(User_management_feature), nameof(Validating_found_users))]
