...
I want to login into system")]
    ...
    public partial class Login_feature
    {
        ...
        [Sync(nameof(Login_feature), nameof(Successful_login))]
        ...
        [Label("Ticket-2")]
        [ScenarioCategory(Categories.Security)]
        [Sync(nameof(Login_feature), nameof(Wrong_login_provided_causes_login_to_fail))]
        ...
        [Label("Ticket-2")]
        [ScenarioCategory(Categories.Security)]
        [Sync(nameof(Login_feature), nameof(Wrong_password_provided_causes_login_to_fail))]
        ...
        [Label("Ticket-3")]
        [ScenarioCategory(Categories.Security)]
        [Sync(nameof(Login_feature), nameof(Anonymous_login_name_should_allow_to_log_in))]
